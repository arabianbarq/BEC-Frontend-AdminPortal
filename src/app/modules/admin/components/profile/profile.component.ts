    ...
    if (this.ProfileForm.valid) {
      ...
      this._profileService.updateProfile({
        ...
        response => {
          ...
          getDetailsFromLocalStorage.FirstName = response.data.userResponse.FirstName;
          getDetailsFromLocalStorage.LastName = response.data.userResponse.LastName;
          getDetailsFromLocalStorage.DateOfBirth = response.data.userResponse.DateOfBirth;
          getDetailsFromLocalStorage.EmailId = response.data.userResponse.EmailId;
          getDetailsFromLocalStorage.Position = response.data.userResponse.Position;
  ...
  uploadProfilePhoto() {
    ...
    this._profileService.uploadProfilePhoto(this.uploadedPhoto).subscribe(
      response => {
        ...
        var getDetailsFromLocalStorage = JSON.parse(localStorage.getItem(this._localStorageService.LOCALSTORAGE_USER_DETAIL_KEY));
        getDetailsFromLocalStorage.UserProfilePhoto = response.data.userResponse.UserProfilePhoto;
        this._localStorageService.storeUserDetail(getDetailsFromLocalStorage);
