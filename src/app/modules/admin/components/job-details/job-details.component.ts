...
import {fileSaver, saveAs as importedSaveAs} from "file-saver";
...
export class JobDetailsComponent implements OnInit {
  ...
  constructor(private http: HttpClient ,private _jobDetailsService: JobdetailsService, private _messageService: MessageService, private _machineTypeService: MachineTypeService,
  ...
  getJobDetails(JobId) {
    this._jobDetailsService.getJobDetails({ JobId: JobId, AllRecords: true }).subscribe(response => {
      ...
      const localDate = this.jobData.StartDate.toLocaleString();
